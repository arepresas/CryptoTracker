...
public class CryptoController {
  ...
  @ResponseStatus(HttpStatus.OK)
  public EntityModel<CryptoCoinPriceDto> getCryptoPrice(@PathVariable Long cryptoCoinPriceId) {
    return cryptoCoinPriceMapper.toDto(cryptoCoinService.getCryptoCoinPrice(cryptoCoinPriceId)).toModel();
  }
  ...
  @ResponseStatus(HttpStatus.OK)
  public EntityModel<CryptoCoinQuoteDto> getCryptoQuote(@PathVariable Long cryptoCoinQuoteId) {
    return cryptoCoinQuoteMapper.toDto(cryptoCoinService.getCryptoCoinQuote(cryptoCoinQuoteId)).toModel();
  }
